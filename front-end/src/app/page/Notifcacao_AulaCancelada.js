...
const Notifcacao_AulaCancelada = () => {
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.checkIconContainer}>
          <Image source={require('../../../assets/cancelamentoTraineer.png')} />
        </View>

        <Text style={styles.title}>Que pena!</Text>

        <Text style={styles.instructions}>
        Mas não se preocupe, você pode agendar outra aula a qualquer momento.Conte sempre com o app Vida de Pet para o melhor para você e seu pet!
        </Text>
...
export default Notifcacao_AulaCancelada;
