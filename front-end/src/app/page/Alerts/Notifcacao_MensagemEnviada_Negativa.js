...
const Notifcacao_MensagemEnviada_Negativa = () => {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        Em breve, nossa equipe analisará o relato enviado e entrará em contato para fornecer um feedback. Obrigado por contribuir!
        </Text>
...
export default Notifcacao_MensagemEnviada_Negativa;
